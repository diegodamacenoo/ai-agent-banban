...
exports.banbanPurchaseFlowSchemas = void 0;
const enums_1 = require("@shared/enums");
exports.banbanPurchaseFlowSchemas = {
    ecaPurchaseOrder: {
        ...
        properties: {
            ...
            transaction_type: {
                type: 'string',
                enum: [enums_1.TRANSACTION_TYPES.ORDER_PURCHASE],
            ...
            status: {
                type: 'string',
                enum: Object.values(enums_1.PURCHASE_STATES),
    ...
    ecaSupplierDocument: {
        ...
        properties: {
            ...
            transaction_type: {
                type: 'string',
                enum: [enums_1.TRANSACTION_TYPES.DOCUMENT_SUPPLIER_IN]
            },
            external_id: {
                type: 'string',
    ...
    ecaPurchaseFlowWebhook: {
        ...
        properties: {
            action: {
                type: 'string',
                enum: Object.values(enums_1.PURCHASE_ACTIONS),
...
//# sourceMappingURL=banban-purchase-flow-schemas.js.map