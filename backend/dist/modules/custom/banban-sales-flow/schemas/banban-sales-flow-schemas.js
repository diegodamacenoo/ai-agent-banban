...
exports.banbanSalesFlowSchemas = void 0;
const enums_1 = require("../../../../shared/enums");
exports.banbanSalesFlowSchemas = {
    saleEntity: {
    ...
    salesFlowWebhook: {
        ...
        properties: {
            action: {
                type: 'string',
                enum: ['register_sale', 'register_payment', 'register_cancellation', 'register_return', 'register_fiscal_data']
            },
            attributes: {
                oneOf: [
                    { $ref: 'banban-sale-entity#' },
                    { $ref: 'banban-return-entity#' }
                ]
            }
        },
    ...
    salesFlowResponse: {
        ...
        properties: {
            ...
            action: {
                type: 'string',
                enum: Object.values(enums_1.SALES_ACTIONS),
...
//# sourceMappingURL=banban-sales-flow-schemas.js.map