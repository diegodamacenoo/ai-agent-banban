...
exports.HealthCheckSchema = exports.AnalyticsSchema = exports.QueryTransfersSchema = exports.ECATransferWebhookSchema = exports.TransferDataSchema = exports.ECATransferDataSchema = void 0;
exports.registerTransferFlowSchemas = registerTransferFlowSchemas;
const enums_1 = require("@shared/enums");
exports.ECATransferDataSchema = {
    type: 'object',
    properties: {
        ...
        transaction_type: {
            type: 'string',
            enum: [enums_1.TRANSACTION_TYPES.TRANSFER_OUT, enums_1.TRANSACTION_TYPES.TRANSFER_IN],
        ...
        status: {
            type: 'string',
            enum: [...Object.values(enums_1.TRANSFER_OUT_STATES), ...Object.values(enums_1.TRANSFER_IN_STATES)],
...
exports.ECATransferWebhookSchema = {
    body: {
        type: 'object',
        properties: {
            action: {
                type: 'string',
                enum: Object.values(enums_1.TRANSFER_ACTIONS),
...
function registerTransferFlowSchemas(fastify) {
    fastify.addSchema({
...
//# sourceMappingURL=banban-transfer-flow-schemas.js.map