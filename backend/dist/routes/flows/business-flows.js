...
exports.businessFlowRoutes = businessFlowRoutes;
async function businessFlowRoutes(server) {
    server.get('/health', {
        schema: {
    ...
    server.get('/purchase/:id?', async (request, reply) => {
...
//# sourceMappingURL=business-flows.js.map