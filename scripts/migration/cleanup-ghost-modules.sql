...
-- ================================================
-- Descomente as linhas abaixo se quiser fazer backup antes da remoção

-- CREATE TABLE backup_organization_modules AS 
-- SELECT * FROM organization_modules 
-- WHERE module_id IN ('banban-analytics', 'banban-components');

-- CREATE TABLE backup_core_modules AS 
-- SELECT * FROM core_modules 
-- WHERE module_id IN ('banban-analytics', 'banban-components');

-- CREATE TABLE backup_tenant_modules AS 
-- SELECT * FROM tenant_modules 
-- WHERE module_id IN ('banban-analytics', 'banban-components');

-- CREATE TABLE backup_module_lifecycle AS 
-- SELECT * FROM module_lifecycle 
-- WHERE module_id IN ('banban-analytics', 'banban-components');
...
-- ================================================
-- Remove referências órfãs em outras tabelas que possam existir

-- Limpar configurações órfãs (se existir tabela de configurações de módulos)
-- DELETE FROM module_configurations
-- WHERE module_id IN ('banban-analytics', 'banban-components');

-- Limpar permissões órfãs (se existir tabela de permissões de módulos)
