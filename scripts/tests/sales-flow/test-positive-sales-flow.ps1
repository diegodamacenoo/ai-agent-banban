...
Write-Host "=== TESTE POSITIVO - SALES FLOW ===" -ForegroundColor Cyan
Write-Host "Testando casos de sucesso..." -ForegroundColor Yellow
Write-Host ""

# Carregar dados de teste
$testDataPath = "$PSScriptRoot\test-sales-flow.json"
...
function Test-PositiveCase {
    ...
    try {
        ...
        $response = Invoke-RestMethod -Uri $SALES_FLOW_URL -Method POST -Headers $VALID_HEADERS -Body $body -ContentType "application/json" -ErrorAction Stop
