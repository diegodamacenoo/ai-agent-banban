# Script de teste para o webhook de transferências
$PSScriptRoot = Split-Path -Parent $MyInvocation.MyCommand.Definition
$testFile = Join-Path $PSScriptRoot "test-transfer-flow.json"
$webhookUrl = "https://bopytcghbmuywfltmwhk.supabase.co/functions/v1/webhook-transfer-flow"
$bearerToken = "BnbNwhTknprD2o25suPasEc"

Write-Host "🧪 Iniciando testes do webhook de transferências..."
