# Script de teste para o webhook de compras
$PSScriptRoot = Split-Path -Parent $MyInvocation.MyCommand.Definition
$testFile = Join-Path $PSScriptRoot "test-purchase-flow.json"
$webhookUrl = "https://bopytcghbmuywfltmwhk.supabase.co/functions/v1/webhook-purchase-flow"
$bearerToken = "BnbNwhTknprD2o25suPasEc"

Write-Host "🧪 Iniciando testes do webhook de compras..."
