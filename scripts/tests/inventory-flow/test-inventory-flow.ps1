# Script de teste para o webhook de inventário
$PSScriptRoot = Split-Path -Parent $MyInvocation.MyCommand.Definition
$testFile = Join-Path $PSScriptRoot "test-inventory-flow.json"
$webhookUrl = "https://bopytcghbmuywfltmwhk.supabase.co/functions/v1/webhook-inventory-flow"
$bearerToken = "BnbNwhTknprD2o25suPasEc"

Write-Host "🧪 Iniciando testes do webhook de inventário..."
