...
export const DebugController = () => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // Extrair módulos únicos dos logs
  ...
  // Função para ativar/desativar logger
  ...
  // Função para mudar nível de log
  ...
  // Função para ativar/desativar logs de um módulo
  ...
  // Função para ativar/desativar destinos de log
