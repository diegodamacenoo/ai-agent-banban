...
const skeletonVariants = cva(
  "animate-pulse rounded-[var(--radius)] bg-[hsl(var(--accent))]",
  {
    variants: {
      variant: {
        default: "bg-[hsl(var(--accent))]",
        secondary: "bg-[hsl(var(--accent))]/20",
        text: "bg-[hsl(var(--accent))] rounded-md",
        circle: "rounded-full",
        avatar: "rounded-full bg-[hsl(var(--accent))]",
      },
      size: {
        sm: "h-4",
        default: "h-6",
