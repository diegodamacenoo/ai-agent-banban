...
export interface LoggerConfig {
  ...
  modules: Record<string, boolean>; // Controle por mÃ³dulo
}

// NÃ­veis de log e seus valores numÃ©ricos (maior = mais detalhado)
...
// Chave para armazenar configuraÃ§Ã£o no localStorage
...
export class Logger {
  ...
  /**
   * ObtÃ©m a instÃ¢ncia Ãºnica do Logger (Singleton)
   */
  ...
  /**
   * Carrega a configuraÃ§Ã£o do localStorage ou usa o padrÃ£o
   */
  private loadConfig(): LoggerConfig {
    ...
    try {
      ...
      // Falha ao carregar do localStorage, usa o padrÃ£o
    }
  ...
  /**
   * Salva a configuraÃ§Ã£o atual no localStorage
   */
  ...
  /**
   * Verifica se um log deve ser exibido com base na configuraÃ§Ã£o
   */
  private shouldLog(level: LogLevel, module?: string): boolean {
    if (!this.config.enabled) return false;
    
    // Verifica se o mÃ³dulo estÃ¡ habilitado (se especificado)
    if (module && this.config.modules[module] === false) {
      return false;
    }
    
    // Verifica se o nÃ­vel do log estÃ¡ habilitado
  ...
  /**
   * Ativa ou desativa o log para um mÃ³dulo especÃ­fico
   */
  ...
  /**
   * Reseta a configuraÃ§Ã£o para o padrÃ£o
   */
...
// FunÃ§Ã£o auxiliar para obter a instÃ¢ncia do logger
