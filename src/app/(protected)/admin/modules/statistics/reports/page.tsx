    ...
    <Layout>
      ...
      <Layout.Body>
        <Layout.Content>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Dashboards de alto nível e exports para tomada de decisão
                </p>
              </div>
            </div>
          </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Relatórios e Exports</CardTitle>
              <CardDescription>
                Esta seção será implementada com relatórios executivos
              </CardDescription>
            </CardHeader>
            <CardContent>
