...
2. **Consume relevant context docs** based on task:
   - Architecture: `context/02-architecture/`
   - Database: `context/06-database/schema-reference.md`
   - Types: `context/07-types/typescript-reference.md`
   - Server Actions: `context/08-server-actions/patterns-guide.md`
   - Security: `context/09-security/rls-security-guide.md`
   - Testing: `context/10-testing/testing-strategy.md`
   - Backend: `context/11-backend/fastify-patterns.md`
...
- `npx supabase gen types typescript` - Gerar tipos TypeScript do schema
...
**📋 See `context/04-development/module-development-guide.md` for complete guide**
...
**📋 See `context/08-server-actions/patterns-guide.md` for complete patterns**
